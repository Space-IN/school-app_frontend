        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.row}>
                ...
                <TouchableOpacity 
                    style={[
                        styles.card,
                        { backgroundColor: !studentData?.attendancePercentage ? "#909691" :
                          studentData?.attendancePercentage > 75 ? "#10b981" :
                          studentData?.attendancePercentage > 45 ? "#f59e0b" : "#e23333ff" }
                    ]}
                ...
                >
                    ...
                    <View style={styles.metricContainer}>
                        ...
                        {studentLoading ? (
                            ...
                            <Text style={[styles.metricText, { marginLeft: 5 }]}>
                ...
                <TouchableOpacity 
                    style={[
                        styles.card,
                        { backgroundColor: !studentData?.grade?.cgpa ? "#909691" :
                          studentData?.grade > 8 ? "#10b981" :
                          studentData?.grade > 5 ? "#f59e0b" : "#DC2626" }
                    ]}
                ...
                >
                    ...
                    <View style={styles.metricContainer}>
                        ...
                        {studentLoading ? (
                            ...
                            <Text style={[styles.metricText, { marginLeft: 5 }]}>
                                {!studentData?.grade?.cgpa ? "-" :
                                `${(studentData?.grade?.cgpa).toFixed(2)}`}
                            </Text>
                        )}
                    </View>
                </TouchableOpacity>
            ...
            <View style={styles.row2}>
                ...
                {/* FEES */}
                <TouchableOpacity
                    style={[styles.card, { backgroundColor: "#8f1b1bff" }]}
                    onPress={() => navigation.navigate("FeesScreen")}
                >
                    <Text style={styles.cardTitle}>FEES</Text>
                    <View style={styles.divider} />
                    <View style={styles.metricContainer}>
                        <FontAwesome name="inr" size={22} color="white" />
                        <Text style={styles.metricText}>VIEW FEES</Text>
                    </View>
                </TouchableOpacity>
                ...
                <View style={[styles.card, { backgroundColor: remarks === "-" ? "#909691" : "#f59e0b" }]}>
                    ...
                    <View style={styles.metricContainer}>
                        ...
                        <Text style={styles.metricText}>
                            {remarks === "-" ? "NO REMARKS" : `${remarks} REMARKS`}
                        </Text>
                    </View>
                </View>
