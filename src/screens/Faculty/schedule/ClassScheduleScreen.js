          ...
          <View style={styles.periodInner}>
            ...
            <View style={styles.periodMain}>
              <Text style={styles.subjectName}>
                {period.subjectMasterId?.name || period.subject || 'Subject Not Assigned'}
              </Text>
              ...
              <View style={styles.teacherRow}>
                ...
                <Text style={styles.teacherName}>
                  {period.facultyNames?.length > 0 
                    ? period.facultyNames.join(", ") 
                    : period.facultyId || "Teacher TBD"}
                </Text>
              </View>
            </View>
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
        <StatusBar backgroundColor="#c01e12" barStyle="light-content" />
        <View style={styles.container}>
          {/* Flat Header with Back Button */}
            ...
            {daySchedule.length === 0 ? (
              <Animatable.View animation="fadeIn" style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>
                  No classes found for {selectedDay} in Class {grade}-{section}
                </Text>
                <TouchableOpacity 
